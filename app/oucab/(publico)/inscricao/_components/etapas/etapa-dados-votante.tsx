    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => setValue("votante.tituloEleitor", e.target.value.replace(/\D/g, "").slice(0, 12))}
          placeholder="000000000000"
          maxLength={12}
          className={cn((errors.votante as any)?.tituloEleitor && "border-red-500 focus-visible:ring-red-500")}
        />
