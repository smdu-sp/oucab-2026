...
import type { ICandidaturaDetalhe } from '@/services/candidaturas';
...
interface Props {
	candidatura: ICandidaturaDetalhe;
	isDev: boolean;
	backUrl: string;
	titulo?: string;
}

export function CandidaturaDetalhe({ candidatura, isDev, backUrl, titulo = 'Detalhe da Candidatura' }: Props) {
