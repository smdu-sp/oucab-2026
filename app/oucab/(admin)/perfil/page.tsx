		...
		<div className='mx-auto px-0 md:px-8 pb-10 w-full'>
			...
			<div className='grid grid-cols-1 lg:grid-cols-3 gap-5 my-5'>
				<Card className='md:col-span-1 h-full'>
					<CardHeader>
						<CardTitle className='text-base md:text-xl'>Avatar</CardTitle>
					</CardHeader>
				...
				<Card className='md:col-span-2 h-full'>
					<CardHeader>
						...
						<CardDescription>Confira seus dados pessoais</CardDescription>
					</CardHeader>
			...
			<Card>
				<CardHeader>
					<CardTitle className='text-base md:text-xl'>Atividade Recente</CardTitle>
				</CardHeader>
				<CardContent>
