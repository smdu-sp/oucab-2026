...
export default function EsqueciSenhaAiuvlPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await fetch("/api/aiuvl/recuperar-senha", {
        method: "POST",
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center text-sm">
              <Link href="/aiuvl/login" className="text-muted-foreground hover:underline">
                Voltar para o login
              </Link>
            </div>
          </CardContent>
